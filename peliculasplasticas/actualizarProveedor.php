...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
	...
	//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
		...
		<form action="ejecutaactualizarProveedor.php" method="post">
				Id<br><input type="text" class="form-control" name="id_proveedor" value= "<?php echo $id ?>" readonly="readonly"><br>
				Nombre Empresa<br> <input type="text" class="form-control" name="nombre_empresa" value="<?php echo $nombre_empresa?>"><br>
				Material<br> <input type="text" class="form-control" name="material" value="<?php echo $material?>"><br>
				Correo<br> <input type="text" class="form-control" name="email" value="<?php echo $email?>"><br>
				Direccion<br> <input type="text" class="form-control" name="direccion" value="<?php echo $direccion?>"><br>
