...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      <label style="font-size: 14pt; color: #050505;"><b>Ingresa el id Proveedor</b></label>
      <input type="text" name="nit" class="form-control" placeholder="Ingresa el id proveedor" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt; color: #050505;"><b>Ingresa nombre</b></label>
      <input type="text" name="nom" class="form-control"  required placeholder="Ingresa nombre"/>
    </div>
    <div>
      <label style="font-size: 14pt; color: #050505;"><b>Ingresa el material</b></label>
    ...
    <div class="form-group mt-3">
      <label style="font-size: 14pt; color: #050505;"><b>Ingresa el correo</b></label>
      <input type="text" name="email" class="form-control" required placeholder="Ingresa correo" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt; color: #050505;"><b>Ingresa la direccion</b></label>
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><a href='actualizarProveedor.php?id=$arreglo[0]'><img src='images/actualizar.gif' class='img-rounded'></td>";
